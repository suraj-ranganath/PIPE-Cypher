...
Judge-human agreement / $\kappa$ & 0.800 / 0.600 \\
...
\caption{Post-hoc judge calibration packet coverage and judge-human agreement. Human labels calibrate the automated gate after generation and are not used as a generation gate.}
