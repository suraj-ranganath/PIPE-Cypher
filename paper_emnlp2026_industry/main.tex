...
Table~\ref{tab:supported_text_metrics} is evaluator infrastructure rather than a headline result. It documents reference-based text metrics that are useful when debugging answer rendering or near-match behavior. The paper's correctness claims remain grounded in execution accuracy and answer-set F1.
