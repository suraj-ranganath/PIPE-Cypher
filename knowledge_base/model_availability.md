...
Latest June 2, 2026 02:11 UTC `ds-serv6` result:
...
python scripts/render_vllm_capacity_snapshot.py \
  --snapshot-json experiments/snapshots/qwen35b_capacity_20260602_latest.json \
  --output-md knowledge_base/qwen35b_capacity_snapshot_20260601.md \
  --checked-at '<absolute check time>' \
  --exit-code 2 \
  --json-path experiments/snapshots/qwen35b_capacity_20260602_latest.json \
