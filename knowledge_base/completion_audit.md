...
- Deterministic tests pass: `141 passed`.
...
- A target-50 FinBench/SNB ablation suite is running in tmux session `pipecypher_ablation50_qwen9b`, with run prefix `20260601_ablation50_qwen9b`, local Qwen3.5-9B generation/judging, and code revision `b5d4898e4a5f5043c33114a7746e319590f38de1`; at latest inspection it had completed the FinBench unconstrained, reverse-only, and validators+repair cells and was actively generating the FinBench no-retrieval cell, with 363 records in that active run. Details are in `knowledge_base/scaled_ablation_status.md`.
